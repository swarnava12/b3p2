...
<html lang="en">
<?php
$smileCode = $_GET['smileCode'];
//system(python prog.py $smileCode);
?>
<script>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">B3P2</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="forms.html"><i class="fa fa-user fa-fw"></i> About</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Predict Blood-Brain Barrier Permeability</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-8">
                  ...
                  <div code="JME.class" archive="JME.jar" width="80%" height=250 style="">
                  	<param name="options" value="depict,useopenchemli">
                  ...
                  <h3>SMILES: <b><span  id="smiles_container" style="color:#1f9da2"></span></b></h3>
                  <div class="row">
                      <div class="col-lg-3 col-md-6">
                        <form action="predict.php">
                          <input type="hidden" name="smileCode" id="smile_code">
                          <input type="submit" name="sub" value="Predict" class="btn btn-primary">
                        </form>
                      </div>
                      <div class="col-lg-4 col-md-6">
                        <INPUT TYPE="button" VALUE="Clear Editor" align="center" onClick="document.JME.reset()" class="btn btn-warning">
                      </div>
                  </div>
                </div>
                <!-- /.col-lg-8 -->
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">2614</div>
                                    <div>Total CNS Drugs</div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
